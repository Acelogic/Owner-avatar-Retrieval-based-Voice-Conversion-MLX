...
class FeatureInput:
    ...
    def mncrepe(self, method, x, p_len, hop_length):
        # Note: CREPE implementation with MLX is not straightforward
        # You may need to implement a custom CREPE-like algorithm or use an alternative
        print("CREPE is not implemented in MLX. Using a placeholder.")
    ...
    def get_rmvpe(self, x):
        if not hasattr(self, "model_rmvpe"):
            ...
            # Note: RMVPE model needs to be adapted for MLX
